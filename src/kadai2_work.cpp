  ...
  while (ros::ok()) {
    switch(stage){
     ...
     case 30://左
      ...
      case 63://num送るよ
        if((img_l=2) || (img_l=5) || (img_l=8)){
         num.data = 1;
        }
        if((img_l=0) || (img_l=3) || (img_l=6)){
         num.data = 3;
        }
        if((img_l=1) ||(img_l=4) ||(img_l=7)){
         num.data = 5;
        }
        pub_hand_num.publish(num);
    ...
    case 68://tast_2送るよ
      ...
      case 69://横
        ...
        if(l_kyori<0.85){
         ...
         break;
      case 70://num送るよ
        if((img_r=2) || (img_r=5) || (img_r=8)){
         num.data = 1;
        }
        if((img_r=0) ||(img_r=3) ||(img_r=6)){
         num.data = 3;
        }
        if((img_r=1) ||(img_r=4) ||(img_r=7)){
         num.data = 5;
        }
        pub_hand_num.publish(num);
        log_msg.data = "Case29_num2";
